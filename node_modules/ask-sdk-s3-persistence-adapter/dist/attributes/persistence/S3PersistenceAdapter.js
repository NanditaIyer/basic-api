    ...
    S3PersistenceAdapter.prototype.getAttributes = function (requestEnvelope) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        objectId = this.objectKeyGenerator(requestEnvelope);
                        getParams = {
                    ...
                    case 3:
                        ...
                        throw AskSdkUtils_1.createAskSdkError(this.constructor.name, "Could not read item (" + objectId + ") from bucket (" + getParams.Bucket + "): " + err_1.message);
                    case 4:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw AskSdkUtils_1.createAskSdkError(this.constructor.name, "Could not save item (" + objectId + ") to bucket (" + putParams.Bucket + "): " + err_2.message);
